...
const useStyles = makeStyles((theme) => {
  ...
  return {
    ...
    userNameTag: {
      backgroundColor: isDark ? themeColors.background.card : '#eeeeee',
    ...
    drawerPaper: {
      ...
      "& .MuiListItem-root": {
        color: themeColors.primary.contrastText + " !important",
        margin: "4px 16px",
        ...
        "&.Mui-selected": {
          backgroundColor: themeColors.background.selected + " !important",
        },
      },
