...
const CompanyPlan_1 = __importDefault(require("../models/CompanyPlan"));
const AsaasConfig_1 = __importDefault(require("../models/AsaasConfig"));
...
const models = [
    ...
    CompanyPlan_1.default,
    AsaasConfig_1.default
];
